...
import { PlusCircle, Image as ImageIcon, AlertCircle } from 'lucide-react';
...
export default function AddListing() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Pēc veiksmīgas pievienošanas atgriežamies uz sākumlapu
      navigate('/');
    } catch (err: any) {
          ...
          <div className="px-6 py-8 sm:p-10">
            <div className="flex items-center space-x-3 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Aizpildi informāciju par preci vai pakalpojumu, ko vēlies piedāvāt.
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-4 border-t border-slate-200">
                ...
                >
                  {isSubmitting ? 'Saglabā...' : 'Publicēt sludinājumu'}
                </button>
              </div>
            </form>
          </div>
